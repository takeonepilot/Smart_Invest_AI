import tvdatafeed as tvDatafeed
...
class Seis(object):
    ...
    def __init__(self, symbol, exchange, interval):
        ...
        self._consumers = []
        self._updated = (
            None  # datetime of the data bar that was last retrieved from TradingView
        )
    ...
    def is_new_data(self, data):
        ...
        if self._updated != data.index.to_pydatetime()[0]:
            self._updated = data.index.to_pydatetime()[
                0
            ]  # update the datetime of the last sample
            return True
